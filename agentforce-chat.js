(function () {
  ...
  /************************************************************
  Allows the Salesforce prompt or host page to override the
  listener phrases without changing this routing script.
  ************************************************************/
  ...
  /************************************************************
  Prevents duplicate chat event listeners when the script is
  loaded more than once by the storefront or embedded chat.
  ************************************************************/
  ...
  /************************************************************
  Walks flexible Agentforce payload shapes to recover message
  text from nested staticContent, text, value, or content fields.
  ************************************************************/
  ...
  /************************************************************
  Normalizes modern embedded messaging event details into the
  plain message text used by the routing and cart parsers.
  ************************************************************/
  ...
  /************************************************************
  Distinguishes assistant messages from customer messages so
  only Agentforce output can trigger route or cart actions.
  ************************************************************/
  ...
  /************************************************************
  Converts natural budget phrases like "under 5k" or "2k to 4k"
  into the short display label shown on recommendation routes.
  ************************************************************/
  ...
  /************************************************************
  Saves the user's latest ring preference or budget so an
  Agentforce recommendation route can show meaningful context.
  ************************************************************/
  ...
  /************************************************************
  Reads structured Agentforce cart blocks and maps ring/service
  names and prices by product code for later storefront upserts.
  ************************************************************/
  ...
  /************************************************************
  Parses human-readable cart confirmations when hidden listener
  keywords or machine payload lines are not present.
  ************************************************************/
  ...
  /************************************************************
  Parses machine-readable LUMINA_ADD_TO_CART payload lines into
  product and service cart items with optional display details.
  ************************************************************/
  ...
  /************************************************************
  Converts Agentforce route phrases into storefront hash routes
  for either one product detail page or a recommendation set.
  ************************************************************/
  ...
  /************************************************************
  Detects explicit integration commands so normal chat copy does
  not accidentally navigate or add storefront cart items.
  ************************************************************/
  ...
  /************************************************************
  Routes Agentforce cart commands into the storefront bridge,
  creating missing Agentforce products when details are supplied.
  ************************************************************/
  ...
  /************************************************************
  Applies the temporary visual highlight after Agentforce sends
  customers to a recommendation route.
  ************************************************************/
  ...
  /************************************************************
  Main chat event handler: captures user context, then lets only
  Agentforce command messages drive routing or cart behavior.
  ************************************************************/
  ...
  /************************************************************
  Registers Salesforce Embedded Messaging events used by the
  current Agentforce web chat implementation.
  ************************************************************/
  ...
  /************************************************************
  Polls for the older embedded_svc API so the same parser still
  works if a legacy chat bootstrap is loaded.
  ************************************************************/
